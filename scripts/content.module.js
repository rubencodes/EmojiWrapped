...
/* harmony import */ var _utilities_format_seconds__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utilities/format-seconds */ "./src/utilities/format-seconds.ts");
...
function useETA(state, defaultValue) {
    ...
    const calculateETA = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_0__.useCallback)((emojiRemaining) => {
        if (state !== _types_app_state__WEBPACK_IMPORTED_MODULE_6__.State.LoadingStats)
            return undefined;
        const eta = Math.round(emojiRemaining * rate);
        return (0,_utilities_format_seconds__WEBPACK_IMPORTED_MODULE_4__.formatSeconds)(eta);
    }, [rate, state]);
...
function useEmoji() {
    ...
    const [stats, setStats] = (0,_use_cached_state__WEBPACK_IMPORTED_MODULE_1__.useCachedState)(_utilities_Cache__WEBPACK_IMPORTED_MODULE_2__.CacheKey.Stats, [], (value) => {
        setState(value ? _types_app_state__WEBPACK_IMPORTED_MODULE_6__.State.Loaded : _types_app_state__WEBPACK_IMPORTED_MODULE_6__.State.Empty);
    });
    ...
    const loadStats = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_0__.useCallback)((forced) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            setEndTime(Date.now());
            if (state !== _types_app_state__WEBPACK_IMPORTED_MODULE_6__.State.Error)
